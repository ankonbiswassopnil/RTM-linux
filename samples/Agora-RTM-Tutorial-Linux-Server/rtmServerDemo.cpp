...
string APP_ID = "9eee5043f41345949f97a09d9f155072";
string CHOICE = "1";
...
class Demo {
  ...
  public:
    ...
    void p2pChat(const std::string& dst, string msg) {
	...
	cout << "send message to peer failed! return code: "+msg << endl;
       ...
       // if (index < 1 || index > count) {
		...
		exit(0);
            ...
            if (choice == 1) {
                ...
                string dst=RECEIVER_ID;
                //getline(std::cin, dst);
                DemoList[index-1]->p2pChat(dst,MESSAGE);
                //continue;
		cout << "done" << endl;
		exit(0);
            } else if (choice == 2) {
